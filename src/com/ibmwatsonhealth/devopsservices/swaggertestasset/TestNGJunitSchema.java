...
public class TestNGJunitSchema {
	...
	//Seconds
	private Double time;
	private List<TestSuite> testSuites = new ArrayList<TestNGJunitSchema.TestSuite>();
	...
	public static class TestSuite {
		...
		private DateUtils timestamp;
		private Properties properties;
		private String systemOut;
		private String systemError;

		private List<TestCase> testCases = new ArrayList<TestNGJunitSchema.TestCase>();
		...
		public DateUtils getTimestamp() {
			return timestamp;
		}

		
		public void setTimestamp(DateUtils timestamp) {
	...
	public static class Properties {
		private List<Property> properties = new ArrayList<TestNGJunitSchema.Property>();
